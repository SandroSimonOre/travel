...
export const Featured = () => {
    return (
        <div className="px-6 h-auto lg:h-auto" id="rentas_destacadas">
            ...
            <div className="w-full h-auto flex flex-col items-center justify-center lg:grid lg:grid-cols-3 lg:grid-rows-[repeat(3,_24rem)] gap-6">
                {
                    featured.map(item => (
                        <div key={item.bg} className={`w-full h-48 ${item.bg} bg-cover rounded-2xl ${item.span} lg:bg-center lg:h-full`}>
